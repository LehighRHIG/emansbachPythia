void rms(TString infile = "histos.root"){
    set_plot_style();
    gStyle->SetOptStat(0);
    ...
    Double_t espt5[3]={0.383489,0.48719,0.452859};
    Double_t espt15[3]={0.228334,0.265927,0.326304};
    Double_t espt25[3]={0.230073,0.234846,0.256238};
    Double_t espt35[3]={0.218433,0.211277,0.218422};
    Double_t espt45[3]={0.20111,0.190155,0.193811};
