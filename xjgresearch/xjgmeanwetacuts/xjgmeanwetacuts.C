void xjgmeanwetacuts(){
    set_plot_style();
    
    Int_t n= 6;
    Double_t count[6]={0.1,0.2,0.3,0.4,0.7,1.0};
    Double_t fifteen[6]={.3,.625,.8,.9,.975,0};
    Double_t fex[6]={0,0,0,0,0,0};
    Double_t fey[6]={.21,.28,.2,.19,.16,0};
    Double_t thirty[6]={.525,.825,.925,.95,.975,0};
    Double_t tex[6]={0,0,0,0,0,0};
    Double_t tey[6]={.24,.16,.12,.12,.09,0};
