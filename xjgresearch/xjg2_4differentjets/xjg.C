void xjg(TString infile = "histos.root"){
    ...
    TH2* array[16];
    TFile *_file0 = TFile::Open("regtwo.root");
    TH2* xjgjetone = (TH2*)gROOT->FindObject("xjghist");
    array[0]= xjgjetone;
    
    TFile *_file1 = TFile::Open("regthree.root");
    TH2* xjgjettwo = (TH2*)gROOT->FindObject("xjghist");
    array[1]= xjgjettwo;

    TFile *_file2 = TFile::Open("regfour.root");
    TH2* xjgjetthree = (TH2*)gROOT->FindObject("xjghist");
    array[2]= xjgjetthree;
    
    TFile *_file3 = TFile::Open("backtwo.root");
    TH2* xjgjetfour = (TH2*)gROOT->FindObject("xjghist");
    array[3]= xjgjetfour;
    
    TFile *_file4 = TFile::Open("backthree.root");
    TH2* xjgjetfive = (TH2*)gROOT->FindObject("xjghist");
    array[4]= xjgjetfive;

    TFile *_file5 = TFile::Open("backfour.root");
    TH2* xjgjetsix = (TH2*)gROOT->FindObject("xjghist");
    array[5]= xjgjetsix;
    
    TFile *_file6 = TFile::Open("combotwo.root");
    TH2* xjgjetseven = (TH2*)gROOT->FindObject("xjghist");
    array[6]= xjgjetseven;
    
    TFile *_file7 = TFile::Open("combothree.root");
    TH2* xjgjeteight = (TH2*)gROOT->FindObject("xjghist");
    array[7]= xjgjeteight;
    
    TFile *_file8 = TFile::Open("combofour.root");
    TH2* xjgjetnine = (TH2*)gROOT->FindObject("xjghist");
    array[8]= xjgjetnine;
    ...
    for(int i=0;i<9;i++){
        ...
        if(i==0){
            ...
            SetLeg(leg4,.05);
            leg4->SetHeader("Background Jets");
            leg4->Draw();
            array[i]->GetXaxis()->SetLabelOffset(999);
            array[i]->GetXaxis()->SetLabelSize(0);
        }
            ...
            SetLeg(leg5,.05);
            leg5->SetHeader("PYTHIA+Background Jets");
            leg5->Draw();
        }
        else if(i==7){
            array[i]->GetYaxis()->SetLabelOffset(999);
